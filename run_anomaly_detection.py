...
import numpy as np
import torch
from exp.exp_anomaly_detection import Exp_Main
...
# model config file
parser.add_argument('--cfg', type=str, required=True, default='SMD_finetune.yaml', help='exp configure file')

# dataset and dataloader
parser.add_argument('--dset', type=str, required=True, default='SMD', help='dataset name')
...
parser.add_argument('--data_path', type=str, default='Datas/SMD/SMD.npy', help='data file')
...
if __name__ == '__main__':
    ...
    setting_AD = '{}_{}_ft{}_dm{}_nh{}_el{}_dl{}_df{}'.format(
        args.model, args.dset, args.features,
        args.d_model, args.n_heads, 
        args.e_layers, args.d_layers, args.d_ff)
